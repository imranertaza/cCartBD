...
class Brand extends BaseController
{
    ...
    public function watermarkImage($targetFilePath,$image,$watermarkImg){

        $stamp = imagecreatefrompng($targetFilePath. $watermarkImg);
        $im = imagecreatefromjpeg($targetFilePath. $image);
