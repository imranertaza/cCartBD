                ...
                <div class="col-md-9 col-12">
                    <div class="products h-100">
                        <div id="hotPro" class="swiper hotpro mo-text-center">
                            ...
                            <div class="swiper-wrapper">
                                <?php $modules = modules_access(); foreach ($hotProlimit as $pro) { ?>
...
<!--                            </div>-->
                            <div class="swiper-wrapper">
                                <?php foreach ($productsetc as $pro) { ?>
                                    <div class="swiper-slide h-auto  each_pro mo-p-r-0">
                                        <div class="border p-3 product-grid h-100 d-flex align-items-stretch flex-column position-relative">
                                            <?php if ($modules['wishlist'] == 1) { ?>
                                                <?php if (!isset(newSession()->isLoggedInCustomer)) { ?>
                    ...
                    <div class="deal-box border position-relative  h-100 me-md-3 mo-m-r-0">
                        <div class="title  bg-custom-color text-white d-flex justify-content-between ">
                            ...
                            <span class="icon-mt brand-nav">
                                ...
                                <span data-bs-target="#brand" data-bs-slide="prev">
                                    <svg class="left-arr carousel-control-prev ar-prev" xmlns="http://www.w3.org/2000/svg" width="8" height="12" viewBox="0 0 8 12" fill="none">
                                        <path d="M6 12L0 6L6 0L7.4 1.4L2.8 6L7.4 10.6L6 12Z" fill="#FFFBFB" />
                                    </svg>
                                </span>

                                <span data-bs-target="#brand" data-bs-slide="next">
                                    <svg class="carousel-control-next ar-next" xmlns="http://www.w3.org/2000/svg" width="8" height="12" viewBox="0 0 8 12" fill="none">
                                        <path d="M1.4 12L0 10.6L4.6 6L0 1.4L1.4 0L7.4 6L1.4 12Z" fill="#FFFBFB" />
                                    </svg>
                                </span>
                            </span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="products  <?php echo ($key == '0') ? 'active' : ''; ?> p-md-4  text-center">
                                            <div class="ic-pp text-center position-relative p-2 p-md-4 ">
                                                ...
                                                <span class="icon-in-rou"><?php echo $catPop->code; ?></span>
                                            </div>

                                            <div class="text ic-pp-btn">
                                                <p class="cat-title-side">
                                                    <?php echo $catPop->category_name; ?>
                                                </p>
                                                <p class="cat-text-side">
                                                    <?php echo substr($catPop->description, 0, 30); ?>
                                                </p>
                                                <a href="#" class="bg-custom-color">
                                                    <svg class="mt-2 bg-custom-color" style="background-color:#1359a9  !important;" xmlns="http://www.w3.org/2000/svg" width="40" height="39" viewBox="0 0 40 39" fill="none">
                                                        <rect width="40" height="39" rx="4" />
                            ...
                            ?>
                                <div class="col p-2 p-md-3 border position-relative">
                                    <a href="<?php echo base_url('category/' . $catPop->prod_cat_id); ?>">
                                        <span class="icon-cat-main"><?php echo $catPop->code; ?></span>
                                        <!--                                        <svg xmlns="http://www.w3.org/2000/svg" width="85" height="85" viewBox="0 0 85 85" fill="none">-->
                                        <!--                                            <circle cx="42.5" cy="42.5" r="42.5" fill="#EDEDED"/>-->
                                        <!--                                        </svg>-->
                                        <h5 class="mt-2 mt-md-4 cat-name"><a href="#"><?php echo $catPop->category_name; ?></a>
                                        </h5>
                                    </a>
                                </div>
                            <?php } ?>
