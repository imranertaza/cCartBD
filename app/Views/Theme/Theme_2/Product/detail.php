...
<!--                                </div>-->
                                ...
                                <button type="submit" class="btn btn-cart rounded-0 mt-2" >Add to Cart</button>
                                    <button type="button" class="btn btn-buy-now rounded-0 mt-2" onclick="buyNowAction()">Buy Now</button>
                                <?php } ?>
                            </form>
                    ...
                    <div class="col-md-12 col-lg-3 side_freeShipping">
...
<script>
    ...
    dataLayer.push({
        ...
        ecommerce: {
            ...
            items: [
                {
                    item_id: "<?php echo $products->product_id;?>",
                    item_name: "<?php echo $products->name;?>",
