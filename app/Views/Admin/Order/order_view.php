        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo base_url('shipped_steadFast/'.$order->order_id) ?>" onclick="return confirm('Are you sure you want Shipped To SteadFast?')" class="btn btn-sm btn-primary float-right " >Shipped To SteadFast</a>
                    </div>
                        ...
                        <div class="tab-content" id="vert-tabs-tabContent">
                            <div class="tab-pane text-left fade  <?php echo isset($_GET['selTab']) ? '' : 'show active'; ?>"
                                ...
                                <table class="table  table-striped text-capitalize">
                                    ...
                                    <tr>
                                        <td>Total</td>
                                        <td><?php echo currency_symbol_admin($order->final_amount); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Order Status</td>
                                ...
                                <table class="table  table-striped text-capitalize">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo currency_symbol_admin($vew->price); ?></td>
                                            <td><?php echo currency_symbol_admin($vew->final_price); ?></td>
                                        </tr>
                                        <?php } ?>

                                        <tr>
                                            <td class="text-right" colspan="3">Sub-Total:</td>
                                            <td><?php echo currency_symbol_admin($order->total); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="3">Discount:</td>
                                            <td><?php echo currency_symbol_admin($order->discount); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="3">Shipping Charge:</td>
                                            <td><?php echo currency_symbol_admin($order->shipping_charge); ?></td>
                                        </tr>
                                        <tr>
