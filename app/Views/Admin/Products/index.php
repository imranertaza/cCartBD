            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <a href="<?php echo base_url('bulk_edit_products') ?>" onclick="bulk_datatable_reset()"
                ...
                <table id="productListData" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $i++;?></td>
                            <td><?php echo image_view('uploads/products',$val->product_id,'50_'.$val->image,'50_noimage.png',$class='');?></td>
