...
$routes->get('/shipped_steadFast/(:num)', 'Admin\Order::shipped_steadFast/$1');
$routes->get('/shipped_order', 'Admin\Order::shipped_order');
...
$routes->get('/otpSubmit', 'Checkout::otpSubmit');
$routes->post('/otpCheck', 'Checkout::otpCheck');
$routes->get('/checkout_done', 'Checkout::checkout_done');
$routes->get('/resend_otp', 'Checkout::resend_otp');
